...
fprintf('BW_3dB:       %.2f\n', bw_calc(Q_3dB_PIFA_LB))
fprintf('BW_Q_Z:       %2.f\n', bw_calc(Q_Z_PIFA_sim(f_PIFA_sim == 0.9e9),-10))
...
fprintf('BW_3dB:       %.2f\n', bw_calc(Q_3dB_PIFA_UB))
fprintf('BW_Q_Z:       %2.f\n', bw_calc(Q_Z_PIFA_sim(f_PIFA_sim == 1.8e9),-10))
...
fprintf('BW_3dB:       ---\n')
fprintf('BW_Q_Z:       %2.f\n', bw_calc(Q_Z_PIFA_meas(f_PIFA_sim == 0.9e9),-10))
...
fprintf('BW_3dB:       ---\n')
fprintf('BW_Q_Z:       %2.f\n', bw_calc(Q_Z_PIFA_meas(f_PIFA_sim == 1.8e9),-10))
...
fprintf('BW_3dB:       %.2f\n', bw_calc(Q_3dB_lambda10))
fprintf('BW_Q_Z:       %2.f\n', bw_calc(Q_Z_lambda10(f_lambda10 == 1.8e9),-10))
...
fprintf('BW_3dB:       %.2f\n', bw_calc(Q_3dB_lambda20))
fprintf('BW_Q_Z:       %2.f\n', bw_calc(Q_Z_lambda20(f_lambda20 == 1.8e9),-10))
