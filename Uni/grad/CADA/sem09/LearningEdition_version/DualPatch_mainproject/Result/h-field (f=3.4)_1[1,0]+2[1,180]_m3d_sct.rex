...
<MetaResultFile version="20210114" creator="Solver HFTD - Field 3DFD Monitor Combine Result">
  ...
  <SimulationProperties fieldname="surface current (f=3.4) [1[1,0]+2[1,180]]" frequency="3.4000000953674316" encoded_unit="&amp;U:A^1.:m^-1" quantity="h-field" fieldtype="Surface current" fieldscaling="PEAK" dB_Amplitude="20"/>
